...
class Exp01:
    ...
    def print_error_report(trained_model, x_train, y_train, x_test, y_test):
        ...
        mean_absolute_perc_error_train = Exp01.compute_mean_absolute_percentage_error(y_train, y_train_pred)
        ...
        mean_absolute_perc_error_test = Exp01.compute_mean_absolute_percentage_error(y_test, y_test_pred)
